...
"""autogenerated by genpy from fsd_common_msgs/ASENSING.msg. Do not edit."""
import codecs
import sys
...
class ASENSING(genpy.Message):
  _md5sum = "71cc4b05e9f3e6f366c4fb6f4c0ec4ed"
  _type = "fsd_common_msgs/ASENSING"
...
"""
  __slots__ = ['latitude','longitude','altitude','north_velocity','east_velocity','ground_velocity','roll','pitch','azimuth','x_angular_velocity','y_angular_velocity','z_angular_velocity','x_acc','y_acc','z_acc','latitude_std','longitude_std','altitude_std','north_velocity_std','east_velocity_std','ground_velocity_std','roll_std','pitch_std','azimuth_std','ins_status','position_type','sec_of_week','gps_week_number','temperature','wheel_speed_status','heading_type','numsv']
  _slot_types = ['float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float32','float32','float32','float32','float32','float32','float32','float32','float32','uint32','uint32','float64','float64','float32','uint32','uint32','uint32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       latitude,longitude,altitude,north_velocity,east_velocity,ground_velocity,roll,pitch,azimuth,x_angular_velocity,y_angular_velocity,z_angular_velocity,x_acc,y_acc,z_acc,latitude_std,longitude_std,altitude_std,north_velocity_std,east_velocity_std,ground_velocity_std,roll_std,pitch_std,azimuth_std,ins_status,position_type,sec_of_week,gps_week_number,temperature,wheel_speed_status,heading_type,numsv
    ...
    """
    if args or kwds:
      super(ASENSING, self).__init__(*args, **kwds)
